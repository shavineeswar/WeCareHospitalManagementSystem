...
<body>
 ...
 <div id="Doctor" class="tabcontent">
        <br>
        <button id="addD"><a href="<%=request.getContextPath()%>/newacc"> Register New Accountant </a></button>
        ...
        <table border="1" width="100%">
            ...
            <!--   for (Todo todo: todos) {  -->
            <c:forEach var="accountant" items="${listAccountant}">
            <tr>
                <td><c:out value="${accountant.aid}" /></td>
                <td><c:out value="${accountant.fullName}" /></td>
                <td><c:out value="${accountant.username}" /></td>
                <td><c:out value="${accountant.password}" /></td>
                <td><c:out value="${accountant.email}" /></td>
                <td><c:out value="${accountant.phone}" /></td>
                <td><c:out value="${accountant.position}" /></td>
                <td><button type='submit'><a href='editacc?aid=<c:out value='${accountant.aid}' />'>EDIT</a></button></td>
                <td><button type='submit'><a href='deleteacc?aid=<c:out value='${accountant.aid}' />'>DELETE</a></button></td>
            </tr>
            </c:forEach>
            <!-- } -->
        </table>
