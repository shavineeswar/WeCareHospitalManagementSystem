...
<body>
 ...
 <div id="Doctor" class="tabcontent">
        <br>
        <button id="addD"><a href="<%=request.getContextPath()%>/newrec"> Register New Receptionist </a></button>
        ...
        <table border="1" width="100%">
            ...
            <!--   for (Todo todo: todos) {  -->
            <c:forEach var="receptionist" items="${listReceptionist}">
            <tr>
                <td><c:out value="${receptionist.rid}" /></td>
                <td><c:out value="${receptionist.fullName}" /></td>
                <td><c:out value="${receptionist.username}" /></td>
                <td><c:out value="${receptionist.password}" /></td>
                <td><c:out value="${receptionist.email}" /></td>
                <td><c:out value="${receptionist.phone}" /></td>
                <td><c:out value="${receptionist.position}" /></td>
                <td><button type='submit'><a href='editrec?rid=<c:out value='${receptionist.rid}' />'>EDIT</a></button></td>
                <td><button type='submit'><a href='deleterec?rid=<c:out value='${receptionist.rid}' />'>DELETE</a></button></td>
            </tr>
            </c:forEach>
            <!-- } -->
        </table>
