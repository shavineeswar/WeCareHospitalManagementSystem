...
<body>
 ...
 <div id="Doctor" class="tabcontent">
        <br>
        <button id="addD"><a href="<%=request.getContextPath()%>/newlab"> Register New Laboratorist </a></button>
        ...
        <table border="1" width="100%">
            ...
            <!--   for (Todo todo: todos) {  -->
            <c:forEach var="laboratorist" items="${listlaboratorist}">
            <tr>
                <td><c:out value="${laboratorist.lid}" /></td>
                <td><c:out value="${laboratorist.fullName}" /></td>
                <td><c:out value="${laboratorist.username}" /></td>
                <td><c:out value="${laboratorist.password}" /></td>
                <td><c:out value="${laboratorist.email}" /></td>
                <td><c:out value="${laboratorist.phone}" /></td>
                <td><c:out value="${laboratorist.position}" /></td>
                <td><button type='submit'><a href='editlab?lid=<c:out value='${laboratorist.lid}' />'>EDIT</a></button></td>
                <td><button type='submit'><a href='deletelab?lid=<c:out value='${laboratorist.lid}' />'>DELETE</a></button></td>
            </tr>
            </c:forEach>
            <!-- } -->
        </table>
