...
<ul>
 ...
 <div id="Doctor" class="tabcontent">
        <br>
        <button id="addD"><a href="<%=request.getContextPath()%>/newph"> Register New Pharmacist </a></button>
        ...
        <table border="1" width="100%">
            ...
            <!--   for (Todo todo: todos) {  -->
            <c:forEach var="pharmacist" items="${listPharmacist}">
            <tr>
                <td><c:out value="${pharmacist.PHid}" /></td>
                <td><c:out value="${pharmacist.fullName}" /></td>
                <td><c:out value="${pharmacist.username}" /></td>
                <td><c:out value="${pharmacist.password}" /></td>
                <td><c:out value="${pharmacist.email}" /></td>
                <td><c:out value="${pharmacist.phone}" /></td>
                <td><c:out value="${pharmacist.position}" /></td>
                <td><button type='submit'><a href='editph?pHid=<c:out value='${pharmacist.PHid}' />'>EDIT</a></button></td>
                <td><button type='submit'><a href='deleteph?pHid=<c:out value='${pharmacist.PHid}' />'>DELETE</a></button></td>
            </tr>
            </c:forEach>
            <!-- } -->
        </table>
